    ...
    return (<div className={"bg-blue-950 py-16 text-white"}>
        <div className={"container flex lg:flex-row flex-col gap-10 justify-between"}>
            ...
            <div className={"w-full"}>
                ...
                <ul>
                    <li className={"text-white mb-3 text-16-24-400 font-extralight"}><a href="https://www.privacypolicygenerator.info/live.php?token=CqkXuAScKnE1xzvmzdijLw5WIQeyOnRo" target="#">Privacy Policy</a></li>
