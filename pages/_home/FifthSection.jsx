  ...
  return (
    ...
    >
      <h2 className={"capitalize text-40-56-700"}>
        ...
        <span className={"text-blue-550"}>startup formula</span>
      </h2>
      <div
        data-aos={"fade-up"}
        ...
        style={{ width: "318px" }}
        className={
          "mx-auto rounded-100 p-1 shadow-s mb-14 mt-10 flex switcher gap-1"
        }
      >
        <div
          className={
            !active
              ? "switcher-item p-2 text-white bg-blue-550 px-3 rounded-100 cursor-pointer text-20-30-500"
              : "switcher-item p-2 px-3 rounded-100 cursor-pointer text-20-30-500"
          }
        ...
        <div
          className={
            active
              ? "switcher-item w-3/5 p-2 rounded-100 bg-blue-550 text-white flex items-center justify-center gap-3 cursor-pointer text-20-30-500"
              : "switcher-item w-3/5 p-2 rounded-100 flex items-center justify-center gap-3 cursor-pointer text-20-30-500"
          }
          onClick={() => setActive(true)}
        >
          Enterprise <Image src={!active ? Right : Right1} alt={"right"} />
        </div>
      </div>
      {!active ? (
        <>
