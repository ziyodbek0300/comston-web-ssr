    ...
    return (<div className={"bg-blue-150 py-12 pb-32 relative"}>
            <div
                ...
                <div className={"w-full"} data-aos={"fade-up"} data-aos-duration={"800"}>
                    <h2 className={"text-40-56-700 mb-6 capitalize"}>{"Forge "} <span
                        className={"text-blue-550"}> Profitable Partnerships </span> and <br/>Secure <span
                        className={"text-blue-550"}>Year-Long Contracts</span> with Our Expertise</h2>
