    ...
    return (
        <div className={"container first-section flex items-center"}>
            <div className={"w-3/4 mx-auto text-center"}>
                ...
                <p className={"text-20-30-500 w-3/4 px-10 mx-auto mb-14"}>We help non-technical founders to <span className={"text-blue-550 border-b border-blue-550 pb-1"}>bring idea to execution</span> or help them scale</p>
